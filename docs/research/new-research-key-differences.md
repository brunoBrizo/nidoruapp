...
**Current docs:** Mixer supports 2-3 layers, 14 launch sounds, per-layer volume, 20/30/45/60 minute timers, smooth fade-out, and offline base sounds. The tech stack proposal explicitly requires two to three simultaneous ambient layers.
