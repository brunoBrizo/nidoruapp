...
Cohesion: 0.1
Nodes (11): AppTabBar(), getTabIndicatorMotionConfig(), HomeBreathingOrb(), getHomeContentEntranceMotionConfig(), HomeEntrancePolish(), markRescueMeTapIfNeeded(), NotificationPermissionGateScreen(), splitHeadline() (+3 more)
...
- **Thin community `Community 23`** (3 nodes): `getLocaleMessages()`, `normalizeLocale()`, `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
